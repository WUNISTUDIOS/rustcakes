...
export default function Privacy() {
  return (
    <div className="about-page privacy-page" style={{ paddingBottom: 'clamp(40px, 6vw, 80px)' }}>
      <section className="content-section">
        <h2 className="section-header">Privacy Policy</h2>

        <div className="body-text">
          <p>
            Your privacy is important to us. It is rustcakes' policy to respect your privacy
            and comply with any applicable law and regulation regarding any personal information
            we may collect about you, including across our website, https://www.rustcakes.com,
            and other sites we own and operate.
          </p>
          <p>
            This policy is effective as of 19 February 2021 and was last updated on 19 February 2021.
          </p>
          ...
          <p>
            ...
            and no one can guarantee absolute data security. We will comply with laws applicable
          ...
          <p>
            ...
            of 13, and we do not knowingly collect personal information about children under 13.
          </p>
          ...
          <p>
            ...
            you initially provided the information. If we transfer your personal information
            to third parties in other countries: (i) we will perform those transfers in
          ...
          <p>
            ...
            we will collect, hold, use and disclose it in accordance with this privacy policy.
          ...
          <p>
            ...
            marketing purposes, you may change your mind at any time. We will provide you
            with the ability to unsubscribe from our email-database or opt out of
            communications. Please be aware we may need to request specific information from
          ...
          <p>
            ...
            opt in to or opt out of, as applicable, any new uses of your personal information.
          </p>
